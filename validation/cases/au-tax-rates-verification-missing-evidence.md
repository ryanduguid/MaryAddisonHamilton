---
id: au-tax-rates-verification-missing-evidence
synthetic: true
target_skills:
  - au-tax-rates-verification
---

# Tax-period source register with missing evidence
...
Use `au-tax-rates-verification` to prepare the supported work and an unresolved-items hand-off.
