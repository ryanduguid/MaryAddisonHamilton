---
id: au-forex-review-missing-evidence
synthetic: true
target_skills:
  - au-forex-review
---

# Foreign currency tax reconciliation with missing evidence
...
Use `au-forex-review` to prepare the supported work and an unresolved-items hand-off.
