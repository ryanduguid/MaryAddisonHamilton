---
id: au-payroll-review-missing-evidence
synthetic: true
target_skills:
  - au-payroll-review
---

# Pay-run preparation review with missing evidence
...
Use `au-payroll-review` to prepare the supported work and an unresolved-items hand-off.
