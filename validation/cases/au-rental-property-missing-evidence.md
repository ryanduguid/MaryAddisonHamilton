---
id: au-rental-property-missing-evidence
synthetic: true
target_skills:
  - au-rental-property
---

# Rental property workpapers with missing evidence
...
Use `au-rental-property` to prepare the supported work and an unresolved-items hand-off.
