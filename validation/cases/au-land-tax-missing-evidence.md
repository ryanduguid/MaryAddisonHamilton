---
id: au-land-tax-missing-evidence
synthetic: true
target_skills:
  - au-land-tax
---

# State land tax assessment review with missing evidence
...
Use `au-land-tax` to prepare the supported work and an unresolved-items hand-off.
