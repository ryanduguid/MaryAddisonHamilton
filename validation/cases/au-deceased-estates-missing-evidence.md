---
id: au-deceased-estates-missing-evidence
synthetic: true
target_skills:
  - au-deceased-estates
---

# Deceased estate tax workpapers with missing evidence

## Scenario

Synthetic Entity A supplies fabricated records for the task below. All records are invented for this case.

Income received after death includes an amount accrued earlier. Preserve the timing facts and verify which taxpayer and period should report it.

## Task

Use `au-deceased-estates` to prepare the supported work and an unresolved-items hand-off.
...
- Separate final-return and estate packs, with a reconciliation of receipts and distributions and an unresolved-authority list. Do not distribute assets or conclude the estate can be wound up.
