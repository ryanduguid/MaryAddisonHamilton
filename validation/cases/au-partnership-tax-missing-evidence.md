---
id: au-partnership-tax-missing-evidence
synthetic: true
target_skills:
  - au-partnership-tax
---

# Partnership tax workpapers with missing evidence

## Scenario

Synthetic Entity A supplies fabricated records for the task below. All records are invented for this case.

Partners draw unequal cash amounts but the agreement records a different profit split. Show both schedules and leave unsupported allocation changes unresolved.

## Task

Use `au-partnership-tax` to prepare the supported work and an unresolved-items hand-off.
