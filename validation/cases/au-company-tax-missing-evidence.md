---
id: au-company-tax-missing-evidence
synthetic: true
target_skills:
  - au-company-tax
---

# Company tax workpapers with missing evidence
...
Use `au-company-tax` to prepare the supported work and an unresolved-items hand-off.
