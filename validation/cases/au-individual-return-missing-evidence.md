---
id: au-individual-return-missing-evidence
synthetic: true
target_skills:
  - au-individual-return
---

# Individual return preparation pack with missing evidence
...
Use `au-individual-return` to prepare the supported work and an unresolved-items hand-off.
