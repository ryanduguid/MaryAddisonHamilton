...
4. Build the annual-return workpaper and unresolved-items register. Keep preparation separate from the required independent audit; record audit status and route findings to the authorised trustee/adviser.
