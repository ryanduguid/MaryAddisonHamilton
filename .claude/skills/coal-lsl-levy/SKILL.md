...
- Client data: follow the firm's CLAUDE.md privacy rules; exclude TFNs and any identifier the task does not need, noting the Levy Advice does require name and date of birth; keep payroll exports and generated output outside every version-control checkout, not merely ignored by one.
